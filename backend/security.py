...
def verificar_password(plain_password: str, hashed_password: str) -> bool:
    """Verifica la contraseña evitando fallos no capturados por tipos/formatos."""
    ...
    try:
        ...
        print(f"⚠️ Error controlado en verificación de hash: {e}")
        return False
...
def obtener_usuario_actual(token: str = Depends(oauth2_scheme)) -> dict:
    """Valida el token en rutas protegidas."""
